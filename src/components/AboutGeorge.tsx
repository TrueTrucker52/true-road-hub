        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-12 items-center">
          <div className="animate-reveal">
            <div className="relative mx-auto max-w-md lg:mx-0">
              <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-primary/20 via-transparent to-accent/20" />
              <div className="relative overflow-hidden rounded-[1.75rem] bg-secondary p-3 shadow-2xl shadow-primary/10">
                <div className="relative overflow-hidden rounded-[1.25rem] aspect-[3/4]">
                  <img src={georgeImg} alt="George Williams — host of True Trucking TV" className="h-full w-full object-cover" />
